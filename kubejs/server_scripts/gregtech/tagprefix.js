...
ServerEvents.highPriorityData(e => {
  const [block, ingot, nugget, rawOre, dust, gem] = [TagPrefix.block, TagPrefix.ingot, TagPrefix.nugget, TagPrefix.rawOre, TagPrefix.dust, TagPrefix.gem]
  ...
  dusts.forEach((m, r) => { Ignore(dust, r, m) })
  gems.forEach((m, r) => { Ignore(gem, r, m) })
})
